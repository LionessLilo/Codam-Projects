...
void	test_strrchr(void)
{
	...
	my_ptr_returned = ft_strrchr("Hello World", 'l');
	std_ptr_returned = strrchr("Hello World", 'l');
	log_test(memcmp(std_ptr_returned, my_ptr_returned,
			sizeof(char) * strlen(std_ptr_returned)) == 0,
		"The returned pointers do not match");

	my_ptr_returned = ft_strrchr("Hello World", '\0');
	std_ptr_returned = strrchr("Hello World", '\0');
	log_test(memcmp(std_ptr_returned, my_ptr_returned,
			sizeof(char) * strlen(std_ptr_returned)) == 0,
